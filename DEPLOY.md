...
4. Em **Environment Variables**, adicione duas regras:
   - `DATABASE_URL` = [Cole a URL do Supabase gerada no Passo 1]
   - `SECRET_KEY` = [Gere uma chave super secreta e longa, ou digite qualquer hash complexo para a segurança do JWT, ex: `94f8b9d3e5a...`]
